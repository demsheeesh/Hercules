...
static int char_mmo_char_fromsql(int char_id, struct mmo_charstatus *p, bool load_everything)
{
	...
	if (SQL_ERROR == SQL->StmtPrepare(stmt, "SELECT `top_damage`, `damage_done`, `damage_received`, `emperium_damage`, `guardian_damage`, `barricade_damage`, `gstone_damage`, `emperium_kill`, `guardian_kill`, `barricade_kill`, `gstone_kill`, `sp_heal_potions`, `hp_heal_potions`, `yellow_gemstones`, `red_gemstones`, `blue_gemstones`, `poison_bottles`, `acid_demostration`, `acid_demostration_fail`, `support_skills_used`, `healing_done`, `wrong_support_skills_used`, `wrong_healing_done`, `sp_used`, `zeny_used`, `spiritb_used`, `ammo_used`, `kill_count`, `death_count`, `score` FROM `char_woe_statistics` WHERE `char_id` = ? and `date`=CURRENT_DATE()")
		|| SQL_ERROR == SQL->StmtBindParam(stmt, 0, SQLDT_INT, &char_id, 0)
		|| SQL_ERROR == SQL->StmtExecute(stmt)
		|| SQL_ERROR == SQL->StmtBindColumn(stmt, 0, SQLDT_UINT,    &p->woe_statistics.top_damage, sizeof woe_statistics.top_damage, NULL, NULL)
		|| SQL_ERROR == SQL->StmtBindColumn(stmt, 1, SQLDT_UINT,	  &p->woe_statistics.damage_done, sizeof woe_statistics.damage_done, NULL, NULL)
		|| SQL_ERROR == SQL->StmtBindColumn(stmt, 2, SQLDT_UINT,	  &p->woe_statistics.damage_received, sizeof woe_statistics.damage_received, NULL, NULL)
		|| SQL_ERROR == SQL->StmtBindColumn(stmt, 3, SQLDT_UINT,	  &p->woe_statistics.emperium_damage, sizeof woe_statistics.emperium_damage, NULL, NULL)
		|| SQL_ERROR == SQL->StmtBindColumn(stmt, 4, SQLDT_UINT, 	  &p->woe_statistics.guardian_damage, sizeof woe_statistics.guardian_damage, NULL, NULL)
		|| SQL_ERROR == SQL->StmtBindColumn(stmt, 5, SQLDT_UINT,    &p->woe_statistics.barricade_damage, sizeof woe_statistics.barricade_damage, NULL, NULL)
		|| SQL_ERROR == SQL->StmtBindColumn(stmt, 6, SQLDT_UINT, 	  &p->woe_statistics.gstone_damage, sizeof woe_statistics.gstone_damage, NULL, NULL)
		|| SQL_ERROR == SQL->StmtBindColumn(stmt, 7, SQLDT_USHORT,  &p->woe_statistics.emperium_kill, sizeof woe_statistics.emperium_kill, NULL, NULL)
		|| SQL_ERROR == SQL->StmtBindColumn(stmt, 8, SQLDT_USHORT,  &p->woe_statistics.guardian_kill, sizeof woe_statistics.guardian_kill, NULL, NULL)
		|| SQL_ERROR == SQL->StmtBindColumn(stmt, 9, SQLDT_USHORT,  &p->woe_statistics.barricade_kill, sizeof woe_statistics.barricade_kill, NULL, NULL)
		|| SQL_ERROR == SQL->StmtBindColumn(stmt, 10, SQLDT_USHORT, &p->woe_statistics.gstone_kill, sizeof woe_statistics.gstone_kill, NULL, NULL)
		|| SQL_ERROR == SQL->StmtBindColumn(stmt, 11, SQLDT_UINT,   &p->woe_statistics.sp_heal_potions, sizeof woe_statistics.sp_heal_potions, NULL, NULL)
		|| SQL_ERROR == SQL->StmtBindColumn(stmt, 12, SQLDT_UINT,   &p->woe_statistics.hp_heal_potions, sizeof woe_statistics.hp_heal_potions, NULL, NULL)
		|| SQL_ERROR == SQL->StmtBindColumn(stmt, 13, SQLDT_UINT,   &p->woe_statistics.yellow_gemstones, sizeof woe_statistics.yellow_gemstones, NULL, NULL)
		|| SQL_ERROR == SQL->StmtBindColumn(stmt, 14, SQLDT_UINT,   &p->woe_statistics.red_gemstones, sizeof woe_statistics.red_gemstones, NULL, NULL)
		|| SQL_ERROR == SQL->StmtBindColumn(stmt, 15, SQLDT_UINT,   &p->woe_statistics.blue_gemstones, sizeof woe_statistics.blue_gemstones, NULL, NULL)
		|| SQL_ERROR == SQL->StmtBindColumn(stmt, 16, SQLDT_UINT,   &p->woe_statistics.poison_bottles, sizeof woe_statistics.poison_bottles, NULL, NULL)
		|| SQL_ERROR == SQL->StmtBindColumn(stmt, 17, SQLDT_UINT,   &p->woe_statistics.acid_demostration, sizeof woe_statistics.acid_demostration, NULL, NULL)
		|| SQL_ERROR == SQL->StmtBindColumn(stmt, 18, SQLDT_UINT,   &p->woe_statistics.acid_demostration_fail, sizeof woe_statistics.acid_demostration_fail, NULL, NULL)
		|| SQL_ERROR == SQL->StmtBindColumn(stmt, 19, SQLDT_UINT,   &p->woe_statistics.support_skills_used, sizeof woe_statistics.support_skills_used, NULL, NULL)
		|| SQL_ERROR == SQL->StmtBindColumn(stmt, 20, SQLDT_UINT,   &p->woe_statistics.healing_done, sizeof woe_statistics.healing_done, NULL, NULL)
		|| SQL_ERROR == SQL->StmtBindColumn(stmt, 21, SQLDT_UINT,   &p->woe_statistics.wrong_support_skills_used, sizeof woe_statistics.wrong_support_skills_used, NULL, NULL)
		|| SQL_ERROR == SQL->StmtBindColumn(stmt, 22, SQLDT_UINT,   &p->woe_statistics.wrong_healing_done,        sizeof woe_statistics.wrong_healing_done, NULL, NULL)
		|| SQL_ERROR == SQL->StmtBindColumn(stmt, 23, SQLDT_UINT,   &p->woe_statistics.sp_used,                 sizeof woe_statistics.sp_used, NULL, NULL)
		|| SQL_ERROR == SQL->StmtBindColumn(stmt, 24, SQLDT_UINT,   &p->woe_statistics.zeny_used,               sizeof woe_statistics.zeny_used, NULL, NULL)
		|| SQL_ERROR == SQL->StmtBindColumn(stmt, 25, SQLDT_UINT,   &p->woe_statistics.spiritb_used,            sizeof woe_statistics.spiritb_used, NULL, NULL)
		|| SQL_ERROR == SQL->StmtBindColumn(stmt, 26, SQLDT_UINT,   &p->woe_statistics.ammo_used,               sizeof woe_statistics.ammo_used, NULL, NULL)
		|| SQL_ERROR == SQL->StmtBindColumn(stmt, 27, SQLDT_USHORT, &p->woe_statistics.kill_count,              sizeof woe_statistics.kill_count, NULL, NULL)
		|| SQL_ERROR == SQL->StmtBindColumn(stmt, 28, SQLDT_USHORT, &p->woe_statistics.death_count,             sizeof woe_statistics.death_count, NULL, NULL)
		|| SQL_ERROR == SQL->StmtBindColumn(stmt, 29, SQLDT_USHORT, &p->woe_statistics.score,                   sizeof woe_statistics.score, NULL, NULL)
